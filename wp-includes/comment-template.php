...
function comment_form( $args = array(), $post_id = null ) {
	...
	$fields   =  array(
		'div_enter' => '<div class="guest-user-form">',
		'author'  => '<p class="comment-form-author">' . '<label for="author">' . __( 'Your Name' ) . ( $req ? ' <span class="required"></span>' : '' ) . '</label> ' .
					 '<input placeholder="Enter your name here" id="author" name="author" type="text" value="' . esc_attr( $commenter['comment_author'] ) . '" size="30" maxlength="245"' . $html_req . ' /></p>',
		'email'   => '<p class="comment-form-email"><label for="email">' . __( 'Your Email' ) . ( $req ? ' <span class="required"></span>' : '' ) . '</label> ' .
					 '<input placeholder="Enter your email here" id="email" name="email" ' . ( $html5 ? 'type="email"' : 'type="text"' ) . ' value="' . esc_attr( $commenter['comment_author_email'] ) . '" size="30" maxlength="100" aria-describedby="email-notes"' . $html_req . ' /></p>',
